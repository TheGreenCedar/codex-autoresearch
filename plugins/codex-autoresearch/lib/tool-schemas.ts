...
const RUNTIME_ARG_ALIASES: Record<string, string> = {
  ...
  clear_packet_budget: "clearPacketBudget",
  clear_wall_clock_budget: "clearWallClockBudget",
  dry_run: "dryRun",
  debug_ledger: "debugLedger",
  env_file: "envFile",
  ...
  no_baseline_log: "noBaselineLog",
  off_limits: "offLimits",
  operator_checklist: "operatorChecklist",
  packet_budget: "packetBudget",
  packet_env_file: "packetEnvFile",
  packet_env_mode: "packetEnvMode",
  revalidate_catalog: "revalidateCatalog",
  protected_benchmark_paths: "protectedBenchmarkPaths",
  quality_constraints: "qualityConstraints",
  secondary_metric_constraints: "secondaryMetricConstraints",
  secondary_metric_constraint_mode: "secondaryMetricConstraintMode",
