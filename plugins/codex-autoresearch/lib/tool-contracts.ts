...
const OUTPUT_FIELD_SCHEMAS: Record<string, JsonSchema> = {
  ...
  decisionEnvelope: objectSchema(
    "Legacy decision guidance input retained for migration compatibility.",
  ),
  ...
  resolvedDecision: objectSchema(
    "Validated cross-surface decision authority with status, blocker, action, safe command, runtime provenance, and finalization pressure.",
  ),
