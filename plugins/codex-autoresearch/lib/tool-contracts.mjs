const CONTRACTS = {
  setup_plan: {
    ...
    outputSchema: basicOutputSchema(["ok", "workDir", "missing", "recommendedRecipe", "guidedFlow"]),
  },
  guided_setup: {
  ...
  list_recipes: {
    purpose: "List built-in and catalog benchmark recipes.",
    whenToUse: "Use when choosing a benchmark starting point.",
