...
const DEFAULT_USAGE_LINES = [
  ...
  "  node scripts/autoresearch.mjs doctor --cwd <project> [--check-benchmark] [--revalidate-catalog] [--allow-fixed-control-rerun] [--explain]",
...
const FULL_USAGE_LINES = [
  ...
  "  node scripts/autoresearch.mjs state --cwd <project> [--compact] [--report]",
  "  node scripts/autoresearch.mjs ledger-doctor --cwd <project> [--json] [--repair --yes]",
  "  node scripts/autoresearch.mjs doctor --cwd <project> [--command <cmd>] [--check-benchmark] [--revalidate-catalog] [--allow-fixed-control-rerun] [--explain]",
