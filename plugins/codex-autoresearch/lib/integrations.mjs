import { loadRecipeCatalog, listBuiltInRecipes } from "./recipes.mjs";
...
export async function integrationsCommand(subcommand, args = {}) {
  ...
  if (subcommand === "doctor") {
    ...
    return { ok: true, integrations: checks };
  }
  if (subcommand === "sync-recipes") {
    ...
    return {
      ...
      message: args.catalog
        ? "Loaded recipe catalog. No local cache was written; pass the catalog again or add it to your workflow."
        : "No catalog provided; returning built-in recipes.",
    };
  }
