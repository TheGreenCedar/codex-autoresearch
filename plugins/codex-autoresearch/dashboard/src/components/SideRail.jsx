export function SideRail({ liveActions }) {
  return (
    <aside className="side-rail" aria-label="Dashboard sections">
      ...
      <div className="side-status">
        <span><span className="live-dot" />{liveActions ? "Live" : "Static"}</span>
        <strong id="side-mode-detail">{liveActions ? "Local actions" : "Snapshot"}</strong>
      </div>
    </aside>
  );
}
