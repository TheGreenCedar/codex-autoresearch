...
1. [Start](start.md): first five minutes, session files, benchmark contract, and first packet.
2. [Walkthrough](walkthrough.md): an end-to-end narrated loop showing inputs and real terminal output.
3. [Operate](operate.md): resume, dashboard, packet logging, quality-gap rounds, and active-loop continuation.
4. [Trust](trust.md): metric integrity, stale packets, drift, dirty Git, static exports, and unsafe command gates.
5. [Finish](finish.md): finalization preview, review branches, merge/cleanup, and reporting.
6. [Recipes](recipes.md): built-in recipes, recommendation flow, benchmark linting, and external catalogs.
7. [Workflow diagrams](workflows.md): the motion of the thing, from first prompt to finalization.
8. [Architecture diagrams](architecture.md): runtime surfaces, trust boundaries, source layout, CLI path, and finalization.
